...
namespace RabbitLink.Topology
{
    ...
    public interface ILinkTopologyConfig
    {
        ...
        Task<ILinkExchange> ExchangeDeclare(
            string name,
        ...
        /// </summary>
        /// <param name="name">name of exchange</param>
        Task<ILinkExchange> ExchangeDeclarePassive(string name);

        /// <summary>
        /// Returns default RabbitMQ exchange
        /// </summary>
        Task<ILinkExchange> ExchangeDeclareDefault();
        ...
        /// <returns></returns>
        Task ExchangeDelete(ILinkExchange exchange, bool ifUnused = false);
        ...
        /// <returns></returns>
        Task Bind(ILinkExchange destination, ILinkExchange source, string routingKey = null,
